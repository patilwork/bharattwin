...
**8 AI agents that predict the Indian stock market. Every day. With a public scoreboard.**

BharatTwin is an open-source agent-based market simulation engine built specifically for the Indian equity market. Eight specialist AI personas — from FII quant strategists to retail momentum traders — analyze live NSE data and produce a consensus Nifty 50 prediction with conviction scores.
